...
function applyTheme(theme){
    if (theme === 'light'){
        ...
        themeIcon && (themeIcon.textContent = 'light_mode');
    } else {
        document.documentElement.classList.remove('light');
        themeIcon && (themeIcon.textContent = 'dark_mode');
    }
...
const APIkey = '55a07feeab8e2ba8a2f2780094a790ae';
...
async function updateWeatherInfo(city) {
    ...
    currentDateTxt.textContent = getCurrrentDate()
